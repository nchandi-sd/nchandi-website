...
import {FacilitiesService} from './facilities-db.service';

@Component({
  selector: 'app-facilities-db',
  templateUrl: './facilities-db.component.html',
  styleUrls: ['./facilities-db.component.scss']
})
export class FacilitiesDBComponent implements OnInit {
  userForm: FormGroup;
  facility: Facility;
  facilities: Facility[];

  constructor(private formBuilder: FormBuilder, private adminService: AdminService, private facilityService: FacilitiesService) { }
